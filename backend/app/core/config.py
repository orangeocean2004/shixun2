...
ALLOWED_UPLOAD_SUFFIXES = {".txt", ".md", ".markdown", ".docx", ".pdf", ".jsonl"}
DEFAULT_MIN_CHARS = 300
DEFAULT_TARGET_CHARS = 900
DEFAULT_MAX_CHARS = 1200
DEFAULT_OVERLAP_SENTENCES = 1
DEFAULT_RETRIEVE_TOP_K = 5
DEFAULT_RETRIEVE_CANDIDATE_MULTIPLIER = 8
DEFAULT_RETRIEVE_MIN_CANDIDATES = 30
RETRIEVE_SEMANTIC_WEIGHT = 0.45
RETRIEVE_LEXICAL_WEIGHT = 0.55
